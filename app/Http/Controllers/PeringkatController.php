...
class PeringkatController extends Controller
{
    ...
    public function showPenilaian()
    {
        ...
        foreach ($penilaian as &$pen) {
            $utilities = $this->calculateTotalUtility($pen);
...
usort($completeData, function ($a, $b) {
    if ($a['penilaian']->tanggal_penilaian === $b['penilaian']->tanggal_penilaian) {
        ...
        return view('Admin.penilaian.peringkat', compact('penilaianForDisplay'));
    }
...
usort($completeData, function ($a, $b) {
    if ($a['penilaian']->tanggal_penilaian === $b['penilaian']->tanggal_penilaian) {
        ...
        return view('Admin.penilaian.cetak', compact('penilaianForDisplay'));
}
