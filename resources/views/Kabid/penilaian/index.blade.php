            ...
            <table class="table ">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="/kabid/penilaian/edit/{{ $data->id }}" class="btn m-1 btn-warning"><i class="bi bi-pencil-square"></i></a>
                    <form action="/kabid/penilaian/delete/{{$data->id}}" method="POST" class="d-inline">
                      @csrf
                      @method('DELETE')
