      ...
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <!-- Vertical Form -->
            <form class="row g-3" action="/admin/penilaian/store" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="col-12">
               ...
               <div class="col-12">
                ...
                <input type="date" class="form-control" value="{{ old('tanggal_penilaian') }}" id="tanggal_penilaian" name="tanggal_penilaian">
              </div>
              {{-- $penilaian->id_pegawai = $request->input('tanggal_penilaian'); --}}
           ...
           <a href="/admin/penilaian" class="btn btn-danger me-1 mb-1">Batal</a>
              </div>
            </form><!-- Vertical Form -->
