      ...
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <a href="/admin/penilaian/create" class="btn btn-success me-1 mb-3 mt-2"><i class="bi bi-plus" ></i>Tambah Data Penilaian</a>
            ...
            <table class="table ">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="/admin/penilaian/edit/{{ $data->id }}" class="btn m-1 btn-warning"><i class="bi bi-pencil-square"></i></a>
                    <form action="/admin/penilaian/delete/{{$data->id}}" method="POST" class="d-inline">
                      @csrf
                      @method('DELETE')
